...
# -*- coding: utf-8 -*-
"""
Created on Thu Jul 29 20:38:31 2021
...
class G(nn.Module):
    ...
    def __init__(self):
        ...
        self.main = nn.Sequential(
            # Input HxW = 128x128
            nn.Conv2d(3, 32, 4, 2, 1), # Output HxW = 64x64
            nn.BatchNorm2d(32),
            nn.ReLU(True),
            nn.Conv2d(32, 64, 4, 2, 1), # Output HxW = 32x32
            nn.BatchNorm2d(64),
            nn.ReLU(True),
            nn.Conv2d(64, 128, 4, 2, 1), # Output HxW = 16x16
            nn.BatchNorm2d(128),
            nn.ReLU(True),
            nn.Conv2d(128, 256, 4, 2, 1), # Output HxW = 8x8
            nn.BatchNorm2d(256),
            nn.ReLU(True),
            nn.Conv2d(256, 512, 4, 2, 1), # Output HxW = 4x4
            nn.BatchNorm2d(512),
            nn.ReLU(True),
            nn.Conv2d(512, 1024, 4, 2, 1), # Output HxW = 2x2
            nn.MaxPool2d((2,2)),
            ...
            nn.BatchNorm2d(32),
            nn.ReLU(True),
            nn.ConvTranspose2d(32, 3, 4, 2, 1, bias = False), # Output HxW = 128x128
            nn.Tanh()
        )
