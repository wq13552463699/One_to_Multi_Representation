...
# rob_cor_1 = (0.3409090786635837, -0.8104717962755162)
# rob_cor_2 = (-0.38937559184413106, -0.8117131022462065)
# rob_cor_3 = (0.4055535333806518, -0.35581374811861755)
# rob_cor_4 = (-0.39863006903597575, -0.3605411343538112)
...
def get_metadata():
    path_to_train_image = '/home/qiang/UR5_sim_coco/train'
    path_to_train_json = "/home/qiang/UR5_sim_coco/annotations/train.json"
...
def get_predictor():
    ...
    cfg.MODEL.WEIGHTS = os.path.join(cfg.OUTPUT_DIR, "/home/qiang/Coppelia_vision_sensor/output/model_final.pth")
...
#     result_cls = outputs["instances"].pred_classes
...
#     for i in result_cls:
#         if i == 3:
#             label_list.append(result_pos[index_label])
#         index_label += 1 
    
#     min_ele = label_list[0][0] + label_list[0][1]
#     max_ele = label_list[0][0] + label_list[0][1]
#     index_pos = 0
#     min_index = 0
#     max_index = 0
#     for element in label_list:
#         buffer = label_list[index_pos][0] + label_list[index_pos][1]
#         if buffer <= min_ele:
#             min_index = index_pos
#             min_ele = buffer
#         elif buffer >= max_ele:
...
#     for element in label_list:
#         if index_e == label1 or index_e == label4:
#             index_e += 1
#         elif label_list[index_e][0] > b1:
#             label2 = index_e
#             b1 = label_list[index_e][0]
#             index_e += 1
            
#     index_e = 0
#     for element in label_list:
#         if index_e == label1 or index_e == label4 or index_e == label2:
#             index_e += 1
#         else:
#             label3 = index_e
    
#     label_coordinate = [label_list[label1], label_list[label2], label_list[label3], label_list[label4]]
